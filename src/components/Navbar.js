  ...
  return (
    <nav className={`fixed left-0 top-0 z-[100] w-screen bg-off-white shadow-2xl`}>
      <div className=" lg:mx-20 lg:flex lg:items-center lg:justify-between lg:px-9 lg:py-6">
        <a className={`my-4 ml-4 inline-block font-kaushan text-[2rem] font-semibold lg:my-0 lg:ml-0 text-gray-dark`}>
          Mathieu Etcheverry
        </a>
        <div onClick={() => setOpen(!open)} className="absolute right-6 top-7 cursor-pointer text-2xl text-gray-dark lg:hidden">
          {open ? (

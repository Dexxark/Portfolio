...
const Skills = () => {
  return (
    <section
      data-section
      id="skills"
      className=" m-auto -my-20 bg-gray-global px-5 py-14 text-black brightness-[1.5] md:py-20 lg:-my-24"
    >
      <h2 className="mb-[30px] mt-4 text-center text-[2.5rem] blur-[0.5px] lg:text-[2.8rem]">
        Mes compétences
      </h2>
